...
class UnitMass(symbol: String, converter: UnitConverter, measureUnit: MeasureUnit? = null) : Dimension(symbol, converter, measureUnit) {
    ...
    private constructor(symbol: String, coefficient: Double, measureUnit: MeasureUnit? = null) : this(symbol, UnitConverterLinear(coefficient), measureUnit)
    ...
    companion object {
        ...
        val slugs = UnitMass(Symbol.slugs, Coefficient.slugs, Unit.slugs)
    }

    override fun baseUnit() = kilograms

    override fun equals(other: Any?): Boolean {
        val oth = other as? UnitMass ?: return false
